                        ...
                        case 1: // product
                            ...
                            switch (chooseMenu)
                            {
                                case 1: // Add
                                    ...
                                    p.InStock = stock;
                                    Dal.DalProduct.AddToProduct(p); // We will call the add function
                                    break;
                                case 2: // get product
                                    int id1;
                                    // We will collect the ID
                                ...
                                case 3: // get all products
                                    Product[] prod = DalProduct.AllProduct(); // We will create a new array
                                    foreach (Product pro in prod) // We will go through all the products and copy to the new system
                                    {
                        ...
                        case 2: // order
                            ...
                            switch (chooseMenu)
                            {
                                case 1: // Add
                                    ...
                                    Dal.DalOrder.AddToOrder(order); // we call to add function
                                    break;
                                case 2: // get order
                        ...
                        case 3: //OrderItem
                            ...
                            switch (chooseMenu)
                            {
                                case 1: // Add
                                    ...
                                    Dal.DalOrderItem.AddToOrderItem(orderItem); // We will call the add function
                                    break;
